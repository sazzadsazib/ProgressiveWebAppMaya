...
class StickeyTextFooter extends Component{
    render(){
        return(
            ...
            <div className="stickey stickey-div">
                ...
                <button className="transparenet-button-left pink darken-2 waves-effect waves-light" type="submit">
                    <img src="assets/img/attachment.png" alt="attach" className="ask_attach_button" />
                </button>
...
export default StickeyTextFooter;